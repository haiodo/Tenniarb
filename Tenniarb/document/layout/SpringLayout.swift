    ...
    private func saveLocations() {
        ...
        for i in 0..<entities.count {
            ...
            self.operations.append(
                layoutContext.store.createUpdatePosition(item: entities[i], newPos: CGPoint(x: locationsX[i], y: locationsY[i])))
        }
    }
            ...
            for i in 0..<self.locationsX.count {
                ...
                for j in i + 1..<self.locationsX.count {
                    ...
                    if sumOfWeights > 0 {
                        ...
                        f =
                            -sprStrain * log(distance / sprLength)
                            * sumOfWeights;
                    } else {
