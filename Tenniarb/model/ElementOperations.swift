...
nonisolated(unsafe) var DEBUG_OPERATION_TRACKING = false
...
public class ModelEvent: @unchecked Sendable {
...
public class ElementOperation: @unchecked Sendable {
...
*/
public class CompositeOperation: ElementOperation, @unchecked Sendable {
...
public class ElementModelStore: @unchecked Sendable {
    public let model: ElementModel

    @MainActor public var onUpdate: [IElementModelListener] = []
    ...
    @MainActor func execute(_ action: ElementOperation, _ undoManager: UndoManager?, _ refresh: @escaping @MainActor () -> Void) {
        ...
        if let manager = undoManager {
            manager.registerUndo(
                withTarget: self,
                handler: { (ae: ElementModelStore) -> Void in
    ...
    @MainActor public func updateName(
        item: DiagramItem, _ newName: String, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
        execute(UpdateName(self, item.parent!, item, old: item.name, new: newName), undoManager, refresh)
    }

    @MainActor public func updateName(
        element: Element, _ newName: String, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
        execute(UpdateElementName(self, element, old: element.name, new: newName), undoManager, refresh)
    }

    @MainActor public func updatePosition(
        item: DiagramItem, newPos: CGPoint, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
    ...
    @MainActor public func compositeOperation(
        notifier: Element, undoManaget: UndoManager?, refresh: @escaping @MainActor () -> Void,
    ...
    @MainActor public func add(
        _ parent: Element, _ child: Element, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void, index: Int? = nil
    ) {
        execute(AddElement(self, parent, child, index: index), undoManager, refresh)
    }

    @MainActor public func addElements(
        _ parent: Element, _ childs: [Element], undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void, index: Int? = nil
    ) {
        var ops: [ElementOperation] = []
        for el in childs {
    ...
    @MainActor public func move(
        _ element: Element, _ newParent: Element, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void, index: Int
    ) {
    ...
    @MainActor public func remove(_ parent: Element, _ child: Element, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void)
    {
        execute(RemoveElement(self, parent, child), undoManager, refresh)
    }

    @MainActor public func add(_ element: Element, _ item: DiagramItem, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void)
    {
        execute(AddItem(self, element, item), undoManager, refresh)
    }

    @MainActor public func add(
        _ element: Element, _ items: [DiagramItem], undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
    ...
    @MainActor public func add(
        _ element: Element, source: DiagramItem, target: DiagramItem, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void,
        props: [TennNode] = []
    ) {
    ...
    @MainActor public func remove(
        _ element: Element, item: DiagramItem, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
        let op = CompositeOperation(self, element)
    ...
    @MainActor public func remove(
        _ element: Element, items deleteItems: [DiagramItem], undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
        let op = CompositeOperation(self, element)
    ...
    @MainActor func modified(_ event: ModelEvent) {
        modified = true
        for op in onUpdate {
    ...
    @MainActor func setProperties(_ element: Element, _ node: TennNode, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void)
    {
        execute(ComplexUpdateElement(self, element, old: element.toTennAsProps(), new: node), undoManager, refresh)
    }

    @MainActor func setProperties(
        _ element: Element, _ item: DiagramItem, _ node: TennNode, undoManager: UndoManager?, refresh: @escaping @MainActor () -> Void
    ) {
...
class AbstractUpdateValue<ValueType>: ElementOperation, @unchecked Sendable {
    let element: Element
...
class AbstractUpdateElementValue<ValueType>: ElementOperation, @unchecked Sendable {
    let element: Element
...
class UpdatePosition: AbstractUpdateValue<CGPoint>, @unchecked Sendable {
    override var name: String {
        get {
...
class UpdateName: AbstractUpdateValue<String>, @unchecked Sendable {
...
class ComplexUpdateItem: AbstractUpdateValue<TennNode>, @unchecked Sendable {
...
class ComplexUpdateElement: AbstractUpdateElementValue<TennNode>, @unchecked Sendable {
...
class UpdateElementName: AbstractUpdateElementValue<String>, @unchecked Sendable {
...
class AddElement: ElementOperation, @unchecked Sendable {
    let parent: Element
    let child: Element
    let index: Int?
...
class AddItem: ElementOperation, @unchecked Sendable {
    let parent: Element
    let item: DiagramItem
    let at: Int?
...
class RemoveElement: ElementOperation, @unchecked Sendable {
    let parent: Element
    let child: Element
...
class RemoveItem: ElementOperation, @unchecked Sendable {
    let parent: Element
